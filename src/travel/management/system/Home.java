...
public class Home extends JFrame{
    ...
    public Home(String username) {
        setTitle("LE Tour and Travel Management System");
	this.username = username;
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/homme.png"));
        Image i2 = i1.getImage().getScaledInstance(1920, 1080,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
//	NewLabel.setBounds(0, 0, 1920, 1080); 
        NewLabel.setBounds(0, 0, 700, 1050); 
//        NewLabel.setBounds(0, 0, 2500, 1080); 
        add(NewLabel);
